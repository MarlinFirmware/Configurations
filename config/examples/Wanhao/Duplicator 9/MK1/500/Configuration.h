 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 15, 0, -1.4 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
 ...
 */
#define EVENT_GCODE_AFTER_G29 "G1 Z10 F1200\nG1 X250 Y250 F6000" // Center the head, so the bed no longer hides the screen
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 3, 3, 0 }
