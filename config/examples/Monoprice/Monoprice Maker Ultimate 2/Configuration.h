...
#define BAUDRATE 115200 // Monoprice Setting
...
#define LEVEL_BED_CORNERS
  ...
  // #define LEVEL_CORNERS_INSET 15 // (mm) (Old Monoprice Ultimate 2) An inset for corner leveling
...
// Use the center of the bed when homing Z
#define Z_SAFE_HOMING
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 195, 145, 20 }
