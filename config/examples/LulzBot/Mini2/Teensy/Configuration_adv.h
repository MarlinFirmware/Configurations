 ...
 */
   ...
   * }
   */
  #define TMC2130_LOW_HEAT(st) st.toff(1); st.hstrt(4); st.hend(0); st.tbl(1); st.semin(1); st.semax(3)
  #define TMC2130_LOW_NOISE(st) st.toff(1); st.hstrt(0); st.hend(0); st.tbl(1); st.semin(1); st.semax(3)
  #define TMC_ADV() { TMC2130_LOW_HEAT(stepperX); TMC2130_LOW_HEAT(stepperY); TMC2130_LOW_HEAT(stepperZ); TMC2130_LOW_NOISE(stepperE0); }
