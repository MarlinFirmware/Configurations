...
/**
 * ADS1118 Sensor Calibration
 * Gain and offset to convert raw → °C
 */
#define TEMP_SENSOR_ADS1118_GAIN   1.5f   // ≈ 1.5 °C LSB (tweak experimentally)
#define TEMP_SENSOR_ADS1118_OFFSET 0.0f   // Offset in °C
 ...
 * Disable to save some flash. Some hosts (Repetier Host) may rely on this feature. 106172 
 */
