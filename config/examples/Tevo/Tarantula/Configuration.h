...
#define STRING_CONFIG_H_AUTHOR "R Brown, Tevo Tarantula" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  841.21
  #define DEFAULT_BED_KI  165.63
  #define DEFAULT_BED_KD 1068.13
