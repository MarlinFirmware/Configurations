...
#define CONFIG_EXAMPLES_DIR "Tevo/Tarantula/Makerbase GEN 1.3 with BLTouch"
 ...
 */
  ...
  #define PROBE_PT_1 {  30,  57 }   // (mm) { x, y }
  #define PROBE_PT_2 { 169,  57 }
  #define PROBE_PT_3 { 100, 170 }
#endif
 ...
 */
  ...
  #define PROBING_MARGIN_RIGHT 31
