...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  27.88       // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  50.98       // (Hz) The default dominant resonant frequency on the Y axis.
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.25        // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
...
#define FWRETRACT
  ...
  #define RETRACT_LENGTH_SWAP         600   // (mm) Default swap retract length (positive value)
