...
#define STRING_CONFIG_H_AUTHOR "(BlackMulch, thinkyhead)" // Original author or contributor.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_TRIGORILLA_F1_V1
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 40, 120 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET      { 0, 0, 0.17 }// (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
