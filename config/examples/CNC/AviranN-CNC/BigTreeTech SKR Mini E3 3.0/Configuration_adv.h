...
#define CONFIG_EXAMPLES_DIR "CNC/AviranN-CNC/BigTreeTech SKR Mini E3 3.0"
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_2_DESC "Set Home Offsets"
  #define MAIN_MENU_ITEM_2_GCODE "M206"
  #define MAIN_MENU_ITEM_2_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_3_DESC "Set XY Zero"
  #define MAIN_MENU_ITEM_3_GCODE "G92 X0 Y0"
  #define MAIN_MENU_ITEM_3_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_4_DESC "Set Z Zero"
  #define MAIN_MENU_ITEM_4_GCODE "G92 Z0"
  #define MAIN_MENU_ITEM_4_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_5_DESC "Set X Zero"
  #define MAIN_MENU_ITEM_5_GCODE "G92 X0"
  #define MAIN_MENU_ITEM_5_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_6_DESC "Set Y Zero"
  #define MAIN_MENU_ITEM_6_GCODE "G92 Y0"
