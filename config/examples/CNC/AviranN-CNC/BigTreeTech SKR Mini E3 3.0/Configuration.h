...
#define STRING_CONFIG_H_AUTHOR "Caraffa-git" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "500W CNC"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 400, 400, 2880 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 15, 15, 5 }
...
#define Z_AFTER_HOMING       Z_MAX_POS   // (mm) Height to move to after homing (if Z was homed)
