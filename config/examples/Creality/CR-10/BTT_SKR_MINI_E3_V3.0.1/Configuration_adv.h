...
#define USE_CONTROLLER_FAN // EDITED: enabled
  ...
  #define CONTROLLER_FAN_EDITABLE           // EDITED: enabled; Enable M710 configurable settings
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // EDITED: FAN1_PIN is used by the BTT board for extruder fan, stock CR10 default: -1
...
#define ASSISTED_TRAMMING // EDITED: enable if you use a probe and want to use it to adjust bed screws
  ...
  #define TRAMMING_POINT_XY { {  30, 30 }, { 270,  30 }, { 270, 270 }, { 30, 270 } } // EDITED: tramming points for CR10 v1, default values are: { {  20, 20 }, { 180,  20 }, { 180, 180 }, { 20, 180 } }
  ...
  #define REPORT_TRAMMING_MM          // EDITED: enabled; Report Z deviation (mm) for each point relative to the first

  #define ASSISTED_TRAMMING_WIZARD    // EDITED: enabled; Add a Tramming Wizard to the LCD menu
   ...
   */
  #define TRAMMING_SCREW_THREAD 41 // EDITED: screw thread for CR10 v1, default value: 30
 ...
 */
#define INPUT_SHAPING_X // EDITED: enabled X input shaping
#define INPUT_SHAPING_Y // EDITED: enabled Y input shaping
#if ANY(INPUT_SHAPING_X, INPUT_SHAPING_Y)
  #if ENABLED(INPUT_SHAPING_X)
    #define SHAPING_FREQ_X  19.62       // EDITED: my value, use default on first run: 40.0; (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  35.15       // EDITED: my value, use default on first run: 40.0; (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y   0.15       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  //#define SHAPING_MIN_FREQ  20.0      // (Hz) By default the minimum of the shaping frequencies. Override to affect SRAM usage.
  //#define SHAPING_MAX_STEPRATE 10000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
  #define SHAPING_MENU                  // EDITED: enabled; Add a menu to the LCD to set shaping parameters.
#endif
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 80*60, 80*60, 6*60, 2*60 } // EDITED: values for faster manual moves, stock CR10 values are: { 50*60, 50*60, 4*60, 2*60 }; (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define PROBE_OFFSET_WIZARD       // EDITED: enabled, disable if you dont use a probe; Add a Probe Z Offset calibration option to the LCD menu
  ...
  #define LCD_INFO_MENU // EDITED: enabled
  ...
  //#define MANUAL_MOVE_DISTANCE_MM                    10, 1.0, 0.1  // EDITED: disabled, I use larger increments; (mm)
  #define MANUAL_MOVE_DISTANCE_MM         100, 50, 10, 1.0, 0.1  // EDITED: enabled, I use larger increments; (mm)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME             // EDITED: enabled, requirement for TFT35; Display estimated time to completion (prefix 'R')
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_LIMIT       40     // EDITED: stock CR10 value is 256; Maximum number of sorted items (10-256). Costs 27 bytes each.
 ...
 */
  ...
  #define USE_BIG_EDIT_FONT // EDITED: enabled, font will be bigger for edit items, disable if you dislike it.
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  1       // EDITED: default is 10; (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 1       // EDITED: default is 10; (steps or mm) Steps or millimeter distance for each Z babystep
  ...
  #define BABYSTEP_ZPROBE_OFFSET            // EDITED: enabled; Combine M851 Z and Babystepping
 ...
 */
#define LIN_ADVANCE // EDITED: enabled
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                   // EDITED: enabled; Requires ~3226 bytes
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   350  // EDITED: default: 0; (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           45  // EDITED: default: 120; (seconds) Time limit before the nozzle is turned off for safety.
  #define FILAMENT_CHANGE_ALERT_BEEPS         10  // EDITED: default: 6; Number of alert beeps to play when a response is needed.
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change.
  //#define HOME_BEFORE_FILAMENT_CHANGE           // EDITED: disabled; If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             // EDITED: enabled; Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       580        // EDITED: default: 650, all below configs modified by same logic; (mA) RMS current. Multiply by 1.414 for peak current. old: 720
    #define X_CURRENT_HOME  (X_CURRENT/2)  // EDITED: default: X_CURRENT, all below configs modified by same logic; (mA) RMS current for homing. (Typically lower than *_CURRENT.)
    ...
    #define Y_CURRENT       580 // EDITED
    #define Y_CURRENT_HOME  (Y_CURRENT/2) // EDITED
  ...
  #define Y_HYBRID_THRESHOLD     165  // EDITED: default: 100; 
  #define Y2_HYBRID_THRESHOLD    165  // EDITED: default: 100; 
  #define Z_HYBRID_THRESHOLD       15 // EDITED: default: 3; 
   ...
   */
  #define EDGE_STEPPING // EDITED: enabled;
