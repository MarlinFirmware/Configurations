...
#define STRING_CONFIG_H_AUTHOR "(garbagexbag)" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes).
//Enabled, changed or commented features are commented with "// EDITED" for you to find easier,
//to indicate what differs from the original CR-10 config or what you might need to
//change yourself.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0 // EDITED, choose your board if it differs from BTT SKR MINI E3 V3. (see boards.h)
#endif
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 // EDITED, serial port for SKR MINI E3 V3
 ...
 */
#define X_DRIVER_TYPE  TMC2209 // EDITED, driver for BTT SKR MINI E3 V3, stock CR10: A4988
#define Y_DRIVER_TYPE  TMC2209 // EDITED, driver for BTT SKR MINI E3 V3 stock CR10: A4988
#define Z_DRIVER_TYPE  TMC2209 // EDITED, driver for BTT SKR MINI E3 V3 stock CR10: A4988
...
#define E0_DRIVER_TYPE TMC2209 // EDITED, driver for BTT SKR MINI E3 V3 stock CR10: A4988
 ...
 */
//#define PIDTEMP         // EDITED: disabled, I don't use PIDTEMP for hotend, I use MPC; See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning
#define MPCTEMP           // EDITED: enabled, I use MPC instead of PID for hotend; ** EXPERIMENTAL ** See https://marlinfw.org/docs/features/model_predictive_control.html
...
#define PID_K1   0.95     // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.98 // EDITED: My old PID settings, default: 22.57
    #define DEFAULT_Ki   2.09 // EDITED: My old PID settings, default: 1.72
    #define DEFAULT_Kd  74.68 // EDITED: My old PID settings, default: 73.96
  #endif
#else
 ...
 */
  ...
  #define MPC_EDIT_MENU                               // EDITED: enabled; Add MPC editing to the "Advanced Settings" menu. (~1.3K bytes of flash)
  #define MPC_AUTOTUNE_MENU                           // EDITED: enabled; Add MPC auto-tuning to the "Advanced Settings" menu. (~350 bytes of flash)
...
#define PIDTEMPBED // EDITED: enabled
  ...
  // Stock CR-10 12v Bed with glass panel tuned for 55C
  #define DEFAULT_bedKp 169.8 // EDITED: my settings, default: 426.68
  #define DEFAULT_bedKi 33.16  // EDITED: my settings, default: 78.92
  #define DEFAULT_bedKd 579.5 // EDITED: my settings, default: 576.71
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU         // EDITED: enabled; Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)
  #define PID_AUTOTUNE_MENU     // EDITED: enabled; Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
...
#define ENDSTOPPULLUPS //  EDITED: enabled;
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98 } // EDITED: modified E-steps to fit my printer, CR10 DEFAULT: { 80, 80, 400, 95 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08  // EDITED: my J value, default for CR10 is 0.067; (mm) Distance from real junction edge
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // EDITED: check how much clearence you need between probes, I clear everything with 3mm, default is 10; (mm) Z Clearance between probe points
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // EDITED: enabled accuracy test, disable if you don't need it or plan on using it
...
#define AUTO_BED_LEVELING_UBL // EDITED: I use UBL for bed levelling.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_MESH_WIZARD         // EDITED: enabled; Run several commands in a row to get a complete mesh
 ...
 */
#define LCD_BED_LEVELING // EDITED: enabled, enables a bed level menu

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU          // EDITED: enabled; Add a menu to edit mesh points
#endif
...
#define HOMING_FEEDRATE_MM_M { (90*60), (90*60), (6*60) } // EDITED: faster homing speeds, defaults are: { (20*60), (20*60), (4*60) }
 ...
 */
#define SKEW_CORRECTION // EDITED: enabled, disable if you dont plan on using it/dont think you need to correct for bed skew.
  ...
  #define SKEW_CORRECTION_FOR_Z // EDITED: enabled, to correct for bed skew in the Z axis
  #if ENABLED(SKEW_CORRECTION_FOR_Z)
    #define XZ_DIAG_AC 141.426 // EDITED: my settings, default: 282.8427124746
  ...
  #define SKEW_CORRECTION_GCODE // EDITED: enabled; disable if you dont use M852/skew correction
#endif
...
//
// EDITED: these are specifically meant for PREHEATING, not values to be used while printing.
// These are set so bed heats up to my preferred temperature of said filament, while nozzle stays far below the melting point for filament not to ooze.
...
#define PREHEAT_5_LABEL       "LEVELLING"
#define PREHEAT_5_TEMP_HOTEND  140
#define PREHEAT_5_TEMP_BED     55
 ...
 */
#define PRINTCOUNTER // EDITED: enabled, shows print statistics
#if ENABLED(PRINTCOUNTER)
  #define PRINTCOUNTER_SAVE_INTERVAL 0 // EDITED: default is 60; (minutes) EEPROM save interval during print. A value of 0 will save stats at end of print.
#endif
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN // EDITED: default is JAPANESE
...
//
#define CR10_STOCKDISPLAY // EDITED: comment: even if you use the BTT TFT35 screen like I do you will leave only this enabled, do not enable any other LCD screens for the TFT35.
