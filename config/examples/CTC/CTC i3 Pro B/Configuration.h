...
#define STRING_CONFIG_H_AUTHOR "(mytja, Anet config)" // Who made the changes.
...
#define EXTRUDE_MINTEMP 10  // 160 guards against false tripping when the extruder fan kicks on.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 77, 78.88, 2555.55, 105.0 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 6, 45 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1400, 1400, 75, 80000 }
...
// bed size(cura input value) X:200 Y:200
// bed center position X:100 Y:100
// build area X_MIN:8 X_MAX:200 Y_MIN:0 Y_MAX:192 (X_MAX-X_MIN:192 Y_MAX-Y_MIN:192)
