...
#define INVERT_I_STEP_PIN true
#define INVERT_J_STEP_PIN true
#define INVERT_K_STEP_PIN true
#define INVERT_U_STEP_PIN true
#define INVERT_V_STEP_PIN true
#define INVERT_W_STEP_PIN true
