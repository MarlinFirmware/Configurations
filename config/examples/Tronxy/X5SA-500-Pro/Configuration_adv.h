...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 250, 20 }, { 470,  20 }, { 470, 480 }, { 250, 480 }, { 20, 480 } }
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 30*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
