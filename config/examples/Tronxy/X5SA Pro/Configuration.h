...
// Though this may be mitigated by the settings
 ...
 *     O-- FRONT --+
 */
// Nozzle is 38.5mm to the left of nozzle and 10mm in front. It triggers when the nozzle is about 6mm above the bed.
...
// The entire bed wobbles back and forth and needs probing every time
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 20.0  // (mm) X point of probe for Z homing
  #define Z_SAFE_HOMING_Y_POINT 20.0  // (mm) Y point of probe for Z homing
